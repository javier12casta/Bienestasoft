...
@Component({
  selector: 'app-ilistadocursosui',
  templateUrl: './ilistadocursosui.component.html',
  styleUrls: ['./ilistadocursosui.component.css']
})
export class IlistadocursosuiComponent implements OnInit {
