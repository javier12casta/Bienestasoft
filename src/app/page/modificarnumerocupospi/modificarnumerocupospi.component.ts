...
@Component({
  selector: 'app-modificarnumerocupospi',
  templateUrl: './modificarnumerocupospi.component.html',
  styleUrls: ['./modificarnumerocupospi.component.css']
})
export class ModificarnumerocupospiComponent implements OnInit {
