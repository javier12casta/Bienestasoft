...
export class MenuComponent implements OnInit {
  ...
  ngOnInit() {
    this.obtenerStorage();
    if (this.estado == 1) {
      this.Service.getPermisosid(this.user.TipoUsuario).subscribe(
        res => {
    ...
    if (array[0] == "1") {
      ...
      if (array[1] == "1") {
        ...
        if (array[2] == "1") {
          if (array[3] == "1") {
            var create = {
              name: "Reporte centro zonal",
              route: "/reportecentrozonal",
              icon: "public"
            };
            this.estructura.push(create);
    ...
    if (array[0] == "1") {
      ...
      if (array[1] == "1") {
        ...
        if (array[2] == "1") {
          if (array[3] == "1") {
            var create = {
              name: "Reporte punto entrega",
              route: "/reportepuntoentrega",
              icon: "face"
            };
            this.estructura.push(create);
            if (array[4] == "1") {
  ...
  cargarpermiso5() {
    ...
    if (array[0] == "1") {
      ...
      if (array[1] == "1") {
        var create = {
          name: "Modificar beneficiarios  ",
          route: "/modificarnivelbeneficiario",
          icon: "face"
        };
        this.beneficiarios.push(create);
        ...
        if (array[2] == "1") {
          if (array[3] == "1") {
            var create = {
              name: "Reporte beneficiarios ",
              route: "/reportebeneficiario",
              icon: "face"
            };
            this.beneficiarios.push(create);
            if (array[4] == "1") {
  ...
  cargarpermiso12() {
    ...
    if (array[0] == "1") {
      ...
      if (array[1] == "1") {
        var create = {
          name: "Reporte recepción",
          route: "/reporterecepcion",
          icon: "list_alt"
        };
        this.recepcion.push(create);
      }
  ...
  devolucion = [];
  cargarpermiso13() {
    var centrostr = this.permisos.perDevolucion;
    var array = centrostr.split("");
    // console.log('carga', array);
    ...
    if (array[0] == "1") {
      ...
      this.devolucion.push(create);
      if (array[1] == "1") {
        var create = {
          name: "Reporte devoluciones",
          route: "/reportedevolucion",
          icon: "list_alt"
        };
        this.devolucion.push(create);
      }
  ...
  cargarpermiso7() {
    ...
    if (array[0] == "1") {
      var create = {
        name: "Crear centro distribución",
        route: "/centrodistribucion",
        icon: "face"
      };
      this.centrod.push(create);
      if (array[1] == "1") {
        var create = {
          name: "Modificar centro distribución",
          route: "/modificarcentrod",
          icon: "face"
        };
        this.centrod.push(create);
        if (array[2] == "1") {
          if (array[3] == "1") {
            var create = {
              name: "Reporte centro distribución",
              route: "/reportecentrodistribucion",
              icon: "face"
            };
            this.centrod.push(create);
            if (array[4] == "1") {
      ...
      if (array[1] == "1") {
        if (array[2] == "1") {
          if (array[3] == "1") {
            ...
            this.inventarios.push(create);
            var create = {
              name: "Reporte recuento de inventario",
              route: "/reporterecuentoinv",
              icon: "store"
            };
            this.inventarios.push(create);
            if (array[4] == "1") {
  ...
  cargarpermiso10() {
    ...
    if (array[0] == "1") {
      var create = {
        name: "Crear servicio y modalidad",
        route: "/serviciosymodalidadesv",
        icon: "face"
      };
      this.datos.push(create);
      var create = {
        name: "Crear referencia bienestarina",
        route: "/referenciasbienestarinav",
        icon: "face"
      };
      this.datos.push(create);
      var create = {
        name: "Crear listado de precios",
        route: "/listapreciosv",
        icon: "face"
      };
      this.datos.push(create);
      var create = {
        name: "Crear listado de cursos",
        route: "/nivelistadocursos",
        icon: "face"
      };
      this.datos.push(create);
      var create = {
        name: "Crear datos nutricionales",
        route: "/niveldatosnutricionales",
        icon: "face"
      };
      this.datos.push(create);
      var create = {
        name: "Crear número de cupos",
        route: "/nivelnumerocupos",
        icon: "face"
      };
      this.datos.push(create);

      var create = {
        name: "Reporte consecutivo maestros",
        route: "/reporteconsecutivomaestro",
        icon: "face"
      };
      this.datos.push(create);
      var create = {
        name: "Ver consecutivos maestros",
        route: "/consecutivomaestrov",
        icon: "face"
      };
      this.datos.push(create);
      ...
      if (array[1] == "1") {
        var create = {
          name: "Modificar servicio y modalidad",
          route: "/modificarserviciom",
          icon: "face"
        };
        this.datos.push(create);
        var create = {
          name: "Modificar referencia bienestarina",
          route: "/modificarreferenciab",
          icon: "face"
        };
        this.datos.push(create);
        var create = {
          name: "Modificar listado de precios",
          route: "/modificarlistac",
          icon: "face"
        };
        this.datos.push(create);
        var create = {
          name: "Modificar listado de cursos",
          route: "/nivelistadocursosm",
          icon: "face"
        };
        this.datos.push(create);
        var create = {
          name: "Modificar datos nutricionales",
          route: "/niveldatosnutricionalesm",
          icon: "face"
        };
        this.datos.push(create);
        var create = {
          name: "Modificar número de cupos",
          route: "/modificarnivelnumerocupos",
          icon: "face"
        };
        this.datos.push(create);
        if (array[2] == "1") {
      ...
      if (array[1] == "1") {
        ...
        var create = {
          name: "Modificar listado de cursos",
          route: "/modificarlistadoc",
          icon: "face"
        };
        this.datos.push(create);
        var create = {
          name: "Modificar datos nutricionales",
          route: "/modificardatosnutricionales",
          icon: "face"
        };
        this.datos.push(create);
        var create = {
    ...
    if (array[0] == "1") {
      ...
      if (array[1] == "1") {
        ...
        if (array[2] == "1") {
          if (array[3] == "1") {
            var create = {
              name: "Reporte almacén",
              route: "/reportealmacen",
              icon: "list_alt"
            };
            this.almacen.push(create);
            if (array[4] == "1") {
