...
@Component({
  selector: 'app-modificarnumerocuposci',
  templateUrl: './modificarnumerocuposci.component.html',
  styleUrls: ['./modificarnumerocuposci.component.css']
})
export class ModificarnumerocuposciComponent implements OnInit {
