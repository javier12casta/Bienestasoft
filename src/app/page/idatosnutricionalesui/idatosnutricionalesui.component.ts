...
@Component({
  selector: 'app-idatosnutricionalesui',
  templateUrl: './idatosnutricionalesui.component.html',
  styleUrls: ['./idatosnutricionalesui.component.css']
})
export class IdatosnutricionalesuiComponent implements OnInit {
