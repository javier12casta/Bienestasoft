...
@Component({
  selector: 'app-inhabilitarnivelnumerocuposui',
  templateUrl: './inhabilitarnivelnumerocuposui.component.html',
  styleUrls: ['./inhabilitarnivelnumerocuposui.component.css']
})
export class InhabilitarnivelnumerocuposuiComponent implements OnInit {
