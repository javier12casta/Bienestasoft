...
@Component({
  selector: 'app-numerocuposci',
  templateUrl: './numerocuposci.component.html',
  styleUrls: ['./numerocuposci.component.css']
})
export class NumerocuposciComponent implements OnInit {
