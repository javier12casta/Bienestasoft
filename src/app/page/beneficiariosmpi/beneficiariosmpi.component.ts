...
@Component({
  selector: 'app-beneficiariosmpi',
  templateUrl: './beneficiariosmpi.component.html',
  styleUrls: ['./beneficiariosmpi.component.css']
})
export class BeneficiariosmpiComponent implements OnInit {
