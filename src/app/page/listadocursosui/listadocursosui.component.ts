...
@Component({
  selector: 'app-listadocursosui',
  templateUrl: './listadocursosui.component.html',
  styleUrls: ['./listadocursosui.component.css']
})
export class ListadocursosuiComponent implements OnInit {
